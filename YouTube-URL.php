...
Description: Replaces YouTube video URL's with the corresponding video. YouTube URL's must be wrapped in "[" and "]" for this to work. This saves you from having to find the embed code, while also making your code much cleaner. 
Version: 1.0
Author: LMP
Author URI: http://liamparker.com/
*/
function youtubeURL($content) {
...
add_filter('the_content', 'youtubeURL');
?>
